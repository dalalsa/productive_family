...
# Product.create(name: "cakes ", image:"ddddd", price: 22, category: "sweet", description: "cakes for best taste", seller_id: 4 );
...
# Product.create(name: "cakes store", image:"ddddd", price: 22, category: "sweet", description: "cakes for best taste", seller_id: 4 );
# Order.create(user_id: 1, status: "pending");
# Item.create(order_id: 6, product_id: 7, quantity: 2, cart_id: 20);
# Item.create(order_id: 6, product_id: 8, quantity: 2, cart_id: 20);
